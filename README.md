...
<!-- Generated by demo/main-demo.tape via VHS; does not exist until rendered. See demo/README.md. -->
![rulem demo](demo/gifs/demo.gif)

*Saving a rule file to the central repository — file picker with live markdown preview, then rename and save.*
