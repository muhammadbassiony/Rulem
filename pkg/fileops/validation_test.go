...
func TestValidationIntegration(t *testing.T) {
	...
	// The containment and access halves of this workflow moved to TestDirStat /
	// TestDirContainment / TestDirOpenAndRead: reaching a file inside a
	// directory is now a Dir operation, not a validator chain. What is left
	// here is the part that still operates on a bare string.
